 ...
 * @version 1.0.0
 */
layui.use(['syk.admin.form','syk.admin.datagrid','syk.admin.tree','syk.admin.common','element'], function(){
	var adminForm = layui['syk.admin.form'],
	adminDatagrid = layui['syk.admin.datagrid'],
	adminTree = layui['syk.admin.tree'],
