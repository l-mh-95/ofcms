 ...
 * @version 1.0.0
 */
layui.define(['layer','syk.admin.common','syk.admin.config'], function(exports){
	var layer = layui.layer,
	fsCommon = layui['syk.admin.common'],
	fsConfig = layui['syk.admin.config'],
...
//			zTree.reAsyncChildNodes(null, type, silent);
	...
	exports("syk.admin.tree",adminTree);
});