 ...
 * @version 1.0.0
 */
layui.define(["syk.admin.common","table",'laypage','syk.admin.config','form','syk.admin.buttion'], function(exports){
  var adminCommon = layui['syk.admin.common'],
  table = layui.table,
  form = layui.form,
  laypage = layui.laypage,
  adminConfig = layui['syk.admin.config'],
  adminButtion = layui['syk.admin.buttion'],
...
//        this.datagrid.reload();
  ...
  exports("syk.admin.datagrid",adminDatagrid);
