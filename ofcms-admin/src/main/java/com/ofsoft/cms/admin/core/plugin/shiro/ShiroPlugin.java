package com.ofsoft.cms.admin.core.plugin.shiro;
...
public class ShiroPlugin implements IPlugin {
			...
			for (Method method : methods) {
				...
				if (!excludedMethodName.contains(method.getName())
					...
					if (authzHandler != null) {
						...
						log.debug("Shiro authz add [ " + actionKey
	...
	private AuthzHandler createAuthzHandler(
		...
		// 至少有一个注解
		List<AuthzHandler> authzHandlers = new ArrayList<AuthzHandler>(
				AUTHZ_ANNOTATION_CLASSES.length);
